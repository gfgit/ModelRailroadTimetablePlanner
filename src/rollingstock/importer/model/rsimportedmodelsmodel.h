...
public:
    ...
    // ICheckName:
    bool checkCustomNameValid(db_id importedModelId, const QString &originalName,
...
private:
    ...
    void handleResult(const QList<ModelItem> &items, int firstRow);

private:
    QList<ModelItem> cache;
    int cacheFirstRow;
    int firstPendingRow;
};
