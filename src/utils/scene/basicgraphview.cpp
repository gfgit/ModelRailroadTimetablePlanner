    ...
    mZoom(100)
{
    ...
    connect(verticalScrollBar(), &QScrollBar::valueChanged, m_verticalHeader,
            &BasicGraphHeader::setScroll);
    connect(horizontalScrollBar(), &QScrollBar::valueChanged, m_horizontalHeader,
            &BasicGraphHeader::setScroll);
...
void BasicGraphView::setScene(IGraphScene *newScene)
{
    ...
    if (m_scene)
    {
        ...
        disconnect(m_scene, &IGraphScene::requestShowRect, this,
                   &BasicGraphView::ensureRectVisible);
